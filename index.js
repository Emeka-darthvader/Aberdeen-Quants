...
function handleMessage(sender_psid, received_message) {
  ...
  if (received_message.text) {
    ...
    callSendAPI(sender_psid, response);  
      ...
      //  });
      response = {
        "text": "Hey, your stocks are doing fine. However visit the official dashboard (at http://msc-financial-dashboard.herokuapp.com) for more info. (Till we launch our conversational agent that is 😉)"
      }
    ...
    callSendAPI(sender_psid, response);  
      ...
      response = {
        "text": "Hey, your stocks are doing fine today. However visit the official dashboard (at http://msc-financial-dashboard.herokuapp.com) for more info. (Till we launch our conversational agent that is 😉)"
      }
       // Sends the response message
    callSendAPI(sender_psid, response);  
    }
